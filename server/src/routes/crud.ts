...
import { retrieveSubjectTopics, retrieveUser, retrieveDataById, retrieveAll, retrieveUnassignedTopics, retrieveTopicsByStatus, retrieveTopicQuizzes, retrieveQuizAttempts, retrieveUserQuizAttempts, retrieveTeacherTopics } from '../controller/read.controller'
...
// route for topics assigned to a teacher
crud.get('/api/teacher/:teacherId/topics', retrieveTeacherTopics)
